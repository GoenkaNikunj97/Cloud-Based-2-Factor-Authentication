...
def dynamodb_handler(event, context):
    ...
    try:
        ...
        send_email(message_subject, message_greetings, message_body, message_closing, message_signature, user_otp, username, topic_arn)
...
def send_email(message_subject, message_greetings, message_body, message_closing, message_signature, user_otp, username, topic_arn):
